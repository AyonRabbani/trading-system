...
LOOKBACK_DAYS = 5  # Reduced - need less history to start trading
SHARPE_LOOKBACK = 45  # Extended Sharpe calculation period
COOLDOWN_DAYS = 35  # Extended cooldown after liquidation
DRAWDOWN_THRESHOLD = 0.10
PM_MOMENTUM_LOOKBACK = 40  # Extended momentum lookback
